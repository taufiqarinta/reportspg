<x-app-layout>
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <form action="{{ route('suratpesananbarang.store') }}" method="POST" id="spbForm">
                        @csrf
                        <input type="hidden" name="total_jumlah_box" id="totalJumlahBoxHidden" value="0">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                            ...
                            <div>
                                ...
                                <input type="text" 
                                       ...
                                       id="penerima"
                                       value="{{ old('penerima') }}" 
                                       class="w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500 uppercase-field"
                                       style="text-transform: uppercase">
                            </div>
                            ...
                            <div>
                                ...
                                <input type="date" 
                                       name="tanggal_kirim" 
                                       value="{{ old('tanggal_kirim', $tanggalKirim) }}" 
                            ...
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-2">Nomor DO</label>
                                <input type="text" 
                                       name="nomor_do" 
                                       id="nomor_do"
                                       value="{{ old('nomor_do') }}" 
                                    ...
                                    <table class="responsive-table">
                                        ...
                                        <tfoot>
                                            <tr class="bg-gray-50 font-bold">
                                                ...
                                                <td class="px-4 py-3"><input type="text" id="totalJumlahBox" class="w-full border-gray-300 rounded-md text-sm bg-gray-100" readonly value="0"></td>
                                                <td colspan="3"></td>
    ...
    <style>
        ...
        #agen-suggestions {
            z-index: 50;
            width: calc(100% - 20px); /* Sesuaikan dengan input */
        }
        ...
        /* Pastikan container relatif untuk positioning yang tepat */
        .relative {
            position: relative;
        }

        /* Tambahkan padding right untuk input agar tombol reset tidak menutupi teks */
        .pr-24 {
            padding-right: 6rem;
        }
    ...
    <script>
        ...
        // Sisanya fungsi untuk detail barang (sama seperti sebelumnya)
        let detailIndex = 1;
