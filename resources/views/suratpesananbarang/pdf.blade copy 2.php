...
<head>
    ...
    <style>
        ...
        .info-table {
            ...
            margin-bottom: 8px;
            font-size: 10px;
            table-layout: fixed; /* Ini yang penting untuk fixed width */
        }
        .info-table td {
            padding: 2px;
            vertical-align: top;
        ...
        .info-label {
            font-weight: bold;
            width: 120px; /* Fixed width untuk label kolom kiri */
        }
        .info-value-left {
            width: 30%; /* Lebar tetap untuk value kolom kiri */
        }
        .info-label-right {
            font-weight: bold;
            width: 120px; /* Fixed width untuk label kolom kanan */
        }
        .info-value-right {
            width: calc(50% - 240px); /* Sisa lebar untuk value kolom kanan */
        }
...
<body>
    ...
    <table class="info-table">
        <tr>
            ...
            <td class="info-label-right">Penerima Barang:</td>
        ...
        <tr>
            ...
            <td class="info-value-left">{{ $suratpesananbarang->pemesan ?? '-' }}</td>
        ...
        <tr>
            <td class="info-label-left">Dikirim Ke:</td>
