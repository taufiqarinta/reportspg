                    ...
                    <form action="{{ route('suratpesananbarang.update', $suratpesananbarang->id) }}" method="POST" id="spbForm">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                            ...
                            <div>
                                ...
                                <input type="text" name="pengirim" value="{{ old('pengirim', $suratpesananbarang->pengirim) }}" class="w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500" required>
                            </div>

                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-2">Penerima Barang <span class="text-red-500">*</span></label>
                                <input type="text" name="penerima" value="{{ old('penerima', $suratpesananbarang->penerima) }}" class="w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500" required>
                            </div>

                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-2">Dikirim Ke <span class="text-red-500">*</span></label>
                                <input type="text" name="dikirim_ke" value="{{ old('dikirim_ke', $suratpesananbarang->dikirim_ke) }}" class="w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500" required>
                            </div>
                            ...
                            <div>
                                ...
                                <input type="text" name="pemesan" value="{{ old('pemesan', $suratpesananbarang->pemesan) }}" class="w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500" required>
                            </div>
