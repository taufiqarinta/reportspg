        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <form method="POST" action="{{ route('daftarharga.store') }}">
                        @csrf
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <x-text-input id="kw" class="block mt-1 w-full uppercase" 
                                    type="text" name="kw" :value="old('kw')" required 
                                    oninput="this.value = this.value.toUpperCase()" />
                            ...
                            <div>
                                ...
                                <x-text-input id="brand" class="block mt-1 w-full uppercase" 
                                    type="text" name="brand" :value="old('brand')" required 
                                    oninput="this.value = this.value.toUpperCase()" />
                            ...
                            <div>
                                ...
                                <x-text-input id="karton" class="block mt-1 w-full uppercase" 
                                    type="text" name="karton" :value="old('karton')" required 
                                    oninput="this.value = this.value.toUpperCase()" />
                            ...
                            <div>
                                ...
                                <x-text-input id="kategori" class="block mt-1 w-full uppercase" 
                                    type="text" name="kategori" :value="old('kategori')" required 
                                    oninput="this.value = this.value.toUpperCase()" />
                            ...
                            <div>
                                ...
                                <x-text-input id="kel_harga_miss2" class="block mt-1 w-full uppercase" 
                                    type="text" name="kel_harga_miss2" :value="old('kel_harga_miss2')" required 
                                    oninput="this.value = this.value.toUpperCase()" />
                            ...
                            <div>
                                ...
                                <x-text-input id="harga_franco" class="block mt-1 w-full" 
                                    type="number" name="harga_franco" :value="old('harga_franco')" 
                            ...
                            <div>
                                ...
                                <x-text-input id="harga_loco" class="block mt-1 w-full" 
                                    type="number" name="harga_loco" :value="old('harga_loco')" 
                                    step="0.01" min="0" required />
