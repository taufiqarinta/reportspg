        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    <form action="{{ route('itemmaster.update', $itemMaster) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="grid grid-cols-1 gap-6">
                            <div>
                                ...
                                <x-text-input id="item_code" 
                                              ...
                                              type="text" 
                                              name="item_code" 
                                              :value="old('item_code', $itemMaster->item_code)" 
                                              required 
                                              autofocus />
                            ...
                            <div>
                                ...
                                <x-text-input id="item_name" 
                                              ...
                                              type="text" 
                                              name="item_name" 
                                              :value="old('item_name', $itemMaster->item_name)" 
                                              required />
                            ...
                            <div>
                                ...
                                <x-text-input id="ukuran" 
                                              ...
                                              type="text" 
                                              name="ukuran" 
                                              :value="old('ukuran', $itemMaster->ukuran)" />
