<x-app-layout>
        ...
        <div class="mx-auto">
            ...
            <div class="mb-4 overflow-auto">
                <div class="flex items-center min-w-[1000px] justify-between gap-4">
                    ...
                    <form action="{{ route('admin.upload') }}" method="GET" class="flex items-center gap-2">
    ...
    <div id="add-activity-modal" tabindex="-1" aria-hidden="true"
        ...
        <div class="relative w-full max-w-md max-h-[90vh] overflow-y-auto p-6 bg-white rounded-lg shadow-lg">
            ...
            <!-- Modal body -->
            <form id="activity-form" method="POST" action="{{ route('admin.upload.store') }}"
    ...
    <script>
        $(document).ready(function() {
            $('.open-delete-modal').on('click', function() {
                ...
                const action = `{{ route('admin.upload.delete', '__ID__') }}`.replace('__ID__', id);
