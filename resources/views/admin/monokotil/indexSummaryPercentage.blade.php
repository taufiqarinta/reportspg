<x-app-layout>
    <x-slot name="header">
        ...
        <form method="GET" action="{{ route('admin.reportPercentage') }}" class="mb-4 text-center">
                        ...
                        @foreach ($grouped as $departement => $employees)
                            ...
                            @foreach ($employees as $index => $employee)
                                <tr>
                                    ...
                                    @endif
                                    <td class="sticky left-[115px] bg-white p-2 font-semibold border border-gray-300">{{ $employee->name }}</td>
